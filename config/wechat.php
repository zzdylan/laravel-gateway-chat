...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx3c8a776f08709841'),         // AppID
    'secret'  => env('WECHAT_SECRET', '90ed73d2d6103bf05f41cd08b2577ce4'),     // AppSecret
     ...
     */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', '/wechat_oauth'),
     ],
